...
conn.browserDescription = ["JiHaD", "Desktop", '10.0']
...
global.reloadHandler = function () {
  ...
  conn.bye = '@user Rest in Peace'
  conn.spromote = '@user Congrats Bruh You Got Admin Role'
  conn.sdemote = '@user Ok Bie Bro Nink Bhakiyam Illa'
